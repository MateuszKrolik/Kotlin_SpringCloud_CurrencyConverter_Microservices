...
<br />
<div align="center">
  <a href="https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices">
    <img src="images/logo.svg" alt="Logo" width="160" height="160">
  </a>

<h3 align="center">Kotlin_SpringCloud_CurrencyConverter_Microservices</h3>
  <p align="center">
    <br />
    <a href="https://github.com/MateuszKrolik/Kotlin_Kotlin_SpringCloud_CurrencyConverter_Microservices"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices">View Demo</a>
    ·
    <a href="https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/issues">Report Bug</a>
    ·
    <a href="https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/issues">Request Feature</a>
  </p>
</div>
...
### Look at below video to see the Distributed BackEnd in action 😉

https://github.com/user-attachments/assets/3b189ef1-e661-496a-9d36-e9a4b866f848
...
- [![Cockroach Labs][Cockroach Labs]][Cockroach Labs-url]
- [![SQL][SQL]][SQL-url]
...
As a prerequisite i recommend having Intellij, Kotlin, JDK21+, Maven and PostgreSQL installed, 
as well as: Docker for Desktop, Kubectl, Minikube, GCloud CLI and a Linux Shell (e.g. WSL2) for my BASH Scripts.
...
- [x] Microservices/Distributed Architecture
- [x] Containerization via Docker and Docker-Compose
- [x] Container Orchestration via K8s on GCP GKE Service
...
- [x] Spring Cloud Framework for Microservices Tooling
- [x] Feign REST Client for Proxy-based communication between services
- [x] Eureka naming server for service discovery
- [x] ConfigServer for centralized config
- [x] Spring Cloud API Gateway for Singular Entrypoint (Edge Server)
- [x] Spring Cloud Load Balancer
- [x] Static IP Address via K8s Service
- [x] Minikube for local K8s Testing
- [x] Monitoring using Spring Boot Actuator
- [x] Fault tolerance via Resilience4j 
- [x] OpenTelemetry-based tracing via Zipkin
- [x] Apache Tomcat Production WebServer
- [x] DTOs via Kotlin's Data Classes
- [x] GCP Hosted Auto-Scaling PostgreSQL DataBase via CockroachDB
...
- [x] Automatized Infra-as-Code Deployment via:
  - [x] Kubernetes & KubeCTL
  - [x] Docker & DockerHub
  - [x] GCP GKE (Google Kubernetes Engine)
  - [x] Declarative YAML Syntax
- [x] Best Practices

See the [open issues](https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/issues) for a full list of proposed features (and known issues).
...
GitHub Repository Link: [GitHub Repository Link](https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices)
...
[contributors-shield]: https://img.shields.io/github/contributors/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices.svg?style=for-the-badge
[contributors-url]: https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices.svg?style=for-the-badge
[forks-url]: https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/network/members
[stars-shield]: https://img.shields.io/github/stars/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices.svg?style=for-the-badge
[stars-url]: https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/stargazers
[issues-shield]: https://img.shields.io/github/issues/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices.svg?style=for-the-badge
[issues-url]: https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/issues
[license-shield]: https://img.shields.io/github/license/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices.svg?style=for-the-badge
[license-url]: https://github.com/MateuszKrolik/Kotlin_SpringCloud_CurrencyConverter_Microservices/blob/master/LICENSE
...
[Cockroach Labs]: https://img.shields.io/badge/Cockroach_Labs-6933FF?style=for-the-badge&logo=cockroach-labs&logoColor=white
[Cockroach Labs-url]: https://www.cockroachlabs.com/
